...
async function main() {
  ...
  for (const category of categories) {
    ...
    for (const file of commandFiles) {
      ...
      const markdown = [
        "---",
        `# DO NOT EDIT THIS FILE. This is automatically generated by the script in \`scripts/docgen/commands.js\`. To update these contents, update the information in \`apps/bot/src/commands/${category}/${file}\`.\n`,
        `title: ${!isNaN(data.name) ? `"${data.name}"` : data.name}`,
        `description: ${data.description}`,
        `editUrl: https://github.com/csmosspace/csmos/edit/main/apps/bot/src/commands/${category}/${file}`,
        "tableOfContents:",
        "  maxHeadingLevel: 5",
        "---\n",
        data.description,
